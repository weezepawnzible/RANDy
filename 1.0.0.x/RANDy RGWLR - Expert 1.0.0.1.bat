...
echo.
echo Generate               [1]
echo Change range and names [2]
echo Exit                   [3]
echo.
echo.
choice /n /c:123 /m "To choose an action press its assigned key, which is showed in the square brackets []"%1
